<?php
    ...
    if(isset($_SESSION['email'])) //if login successfully
    {
      if($_SESSION['login']=='users')
...
<div claas="main">
   <div class="menu_bar">
      <a href="../itjobportalsystem" class="logo">IT<span>JobPortal</span>System</a>
      <nav class="navbar">
      <ul>
         ...
         <div class="center box">
          ...
          <div class="content">
              ...
              <div class="phone">
                  ...
                  <span class="text">0170000000</span>
              </div>
              <div class="email">
