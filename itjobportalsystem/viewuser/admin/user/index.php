    ...
    session_start();
     ...
     if(!isset($_SESSION['email'])) //if login not successfully
     {
        header('location:http://localhost/itjobportalsystem/viewuser/');
          ...
          header('location:http://localhost/itjobportalsystem/viewuser/cm');
...
<div claas="main">
        ...
        <fonm action="#" method="post">
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="e" value="<?php echo $email; ?>" readonly>
                </div>
                <div class="input-box">
    ...
    <form action="action.php" method="post">
        <input type="text" name="email" value="<?php echo $email; ?>" style="visibility: hidden;">
        <br>
        <input id="SubBtn" type="submit" value="Remove the User" >
    </form>
    </div>
</div>
</body>
