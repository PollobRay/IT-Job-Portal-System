<?php
    ...
    $q="SELECT * FROM applyjob ,users WHERE applyjob.user_email=users.email && applyjob.job_serial_no=$serial; ";
...
<div claas="main">
   ...
   <div class="secondDiv" style="height:100%;">
         <div class="inner-box" style="width:60%;  margin: right 10px; padding: right 20px;">
            <br><br>
            <h1 style="color:red; text-align:center;">Applicant List</h1>
            <hr>
            <br><br>
