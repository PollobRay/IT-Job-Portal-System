...
<body>
<script>
function selectDegree(dnum)
{
    document.getElementById('degreelist').options[dnum].selected = 'selected';  
}
            ...
            <div class="card-front">
               ...
               <form action="update.php" method="post">
                     ...
                     <div class="row">
                           ...
                           <div class="col-75">
                              <input type="text" id="jtitle" value="<?php echo $title; ?>" name="jtitle" placeholder="Job title.." >
                           </div>
                     </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-75">
                           <textarea id="text" name="des" rows="3" cols="29"   placeholder="add description.." ><?php echo $description; ?></textarea>
                        </div>
                    </div>
                  ...
                  <div class="row">
                        ...
                        <div class="col-75">
                           <input type="text" id="exp" name="experience" value="<?php echo $experience; ?>" placeholder="experence.." oninput="this.value=this.value.replace(/[^0-9]/g,''); ">
                        </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-75">
                        <input type="text" id="vacancy" value="<?php echo $vacancy; ?>" name="vacancy" placeholder="add vacancy.." oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
                     ...
                     <div class="col-75">
                        <input type="date" id="vacancy" name="ddate" value='<?php echo $ddate; ?>' placeholder="add deadline..">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
                     ...
                     <div class="col-75">
                        <input type="text" id="sal" name="salary" value="<?php echo $salary; ?>" placeholder="add salary.." oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                     </div>
                  </div>
               
                  <div class="row">
                     <input type="submit" value="Update" name="update">
                     <input type="submit" value="View Applicant list" name="viewapl">
                  </div><br><br>
               </div>
            </form>  
