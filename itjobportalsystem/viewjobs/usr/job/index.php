<?php
    ...
    {
             //header('location:http://localhost/jobsite/viewjobs/usr');
    }
   else //if comapny
         header('location:http://localhost/itjobportalsystem/viewjobs/');
...
function canApplyAlert()
{
        ...
        {
            //alert("You can apply");
            window.location="http://localhost/itjobportalsystem/viewjobs/usr/job/action.php";
        }
...
<div claas="main">
   ...
   <br><br><br><br>
   <h2 style="text-align: center; background-color:#e9f437; ">If the Account is not Approved, then can't apply the job</h2>
   <div class="secondDiv">
         <div class="inner-box">
