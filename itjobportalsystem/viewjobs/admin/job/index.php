...
{
       // if("<?php //echo $canApply; ?>"=="no") always false
        //{
            ...
            <div class="card-front">
               <h2>Job Details</h2><br><br>
                    <form action="action.php" method="post">
                        ...
                        <div class="row">
                            <input id="jpass" name="jpass" type="text" value="<?php echo $serial; ?>" style="visibility: hidden;" >
                            <input type="submit" value="Remove the Job">
                        </div><br><br>
                    </div>
                </form>
